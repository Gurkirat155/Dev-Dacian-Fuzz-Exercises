...
contract ProposalModified {
    ...
    uint256 public s_totalAllowedVoters;

    // total number of current votes
    uint256 public s_totalCurrentVotes;
    ...
    function votersFor() external view returns(address[] memory){
        return s_votersFor;
    }

    function votersAgainst() external view returns(address[] memory){
        return s_votersAgainst;
    }
}